...
- **Y. Yu**, D. Lin*, et al. Spatial-temporal Fuzzy Logic-Driven Topological Decoupling Mechanism with Balanced Supply and Demand in Data and Energy for BSSN. *IEEE Journal on Selected Areas in Communications*, 2026, **Accepted**. (**CCF‑A推荐期刊, 中科院一区Top, IF: 17.2**)
- **Y. Yu**, W. Luo, L. Zeng, D. Lin*, et al. ECAEP: An Energy-efficient Clustering Approach based on Wireless Energy Provision for WSNs. *IEEE Transactions on Mobile Computing*, 2026, **Accepted**. (**CCF‑A推荐期刊, 中科院一区Top, IF: 9.2**)
...
- **Y. Yu**, D. Lin*, et al. A Spatial-temporal Topological Decoupling Method in Battery-free Sensor Networks. *IEEE WCNC 2026*, **Accepted**. (**CCF‑C推荐会议**)
- **Y. Yu**, D. Lin*, et al. A Queuing Theory-based Dynamic Adaptive Energy Sustainability Algorithm in Battery-free Sensor Networks. *IEEE ICC 2026 Workshop*, **Accepted**. (**EI会议**)
